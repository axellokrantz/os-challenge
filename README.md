...
| Delay μs | TP + Priority (avg. score) | TP + Priority Queue (best score) | TP + Priority (worst score) | Threads + Priority (avg. score) | Threads + Priority (best score) | Threads + Priority (worst score) |
|----------|---------------------------------------------|---------------------------------------------|----------------------------------------------|---------------------------------------|--------------------------------------|---------------------------------------|
